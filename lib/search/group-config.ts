...
const groupTools = {
  ...
  academic: ['text_translate', 'datetime', 'file_query_search'] as const,
  youtube: ['text_translate', 'datetime', 'file_query_search'] as const,
  spotify: ['text_translate', 'datetime', 'file_query_search'] as const,
  code: ['text_translate', 'file_query_search'] as const,
  reddit: ['text_translate', 'datetime', 'file_query_search'] as const,
  github: ['text_translate', 'datetime', 'file_query_search'] as const,
  stocks: ['text_translate', 'datetime', 'file_query_search'] as const,
  crypto: ['text_translate', 'datetime', 'file_query_search'] as const,
  chat: ['file_query_search'] as const,
  extreme: ['text_translate', 'datetime', 'file_query_search'] as const,
  x: ['x_search', 'file_query_search'] as const,
  memory: ['text_translate', 'datetime', 'file_query_search'] as const,
  connectors: ['text_translate', 'datetime', 'file_query_search'] as const,
  mcp: ['text_translate', 'datetime', 'file_query_search'] as const,
  'multi-agent': ['xai_web_search', 'xai_x_search'] as const,
  buddy: ['text_translate', 'datetime', 'file_query_search'] as const,
  prediction: ['text_translate', 'datetime', 'file_query_search'] as const,
  canvas: ['text_translate', 'datetime', 'file_query_search'] as const,
} as const;
